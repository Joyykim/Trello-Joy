                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                $loggedIn = $_SESSION['ses_username'] != null;
                                ...
                                //POST 에서 ID,password 가져오기
                                $memberId = $_POST['memberId'];
                                $memberPw = hash("sha256", $_POST['memberPw']); //암호화
                                ...
                                <form class="user" action="logIn.php" method="post" onsubmit="return login_SubmitCheck()">
...
<script>
    function login_SubmitCheck(){
        var memberId = $('#logInID');
        var memberPw = $('#logInPassword');
