            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form class="user" name="signUp" action="register.php" method="post"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <div class="memberIdCheck" type="button">중복 확인</div>
                                </div>
                                <!--닉네임-->
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-user" id="registerNickname"
                                           name="memberNickName" placeholder="Nick name">
                                </div>
                            </div>
                            <div class="form-group">
                                <!--이메일-->
                                <input type="email" class="form-control form-control-user" id="registerEmail"
                                       name="memberEmailAddress" placeholder="Email Address">
                            </div>
                            <div class="form-group row">
                                <!--비밀번호-->
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="password" class="form-control form-control-user" id="registerPW"
                                           name="memberPw" placeholder="Password">
                                </div>
                                <!--비밀번호2-->
                                <div class="col-sm-6">
                                    <input type="password" class="form-control form-control-user" id="registerRepeatPassword"
                                           name="memberPw2" placeholder="Repeat Password">
